...
abstract class Migration
{
     ...
     * @return $this
     */
    protected function addAttribute($name, $dataType)
    {
     ...
     * @return $this
     */
    protected function addHash($attributeName)
    {
        $this->setKeySchema();
     ...
     * @return $this
     */
    protected function addRange($attributeName)
    {
        $this->setKeySchema();
        array_push($this->tableParams['KeySchema'],  ['AttributeName' => $attributeName, 'KeyType' => 'HASH']);
     ...
     * @return $this
     */
    protected function setWCU($unit)
    {
     ...
     * @return $this
     */
    protected function setRCU($unit)
    {
        $this->setProvisionedThroughput();
    ...
    /**
     * Set the AttributeDefinition to an empty array.* This will make setting the attributes easier.
     */
